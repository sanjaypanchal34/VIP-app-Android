...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            left_drawable = ta.getResourceId(R.styleable.MaterialSpinner_left_drawable, 0);
            int right_drawable = ta.getResourceId(R.styleable.MaterialSpinner_right_drawable, 0);
            ...
            drawable_padding = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_drawable_padding, 0);
            popupPaddingTop =
        ...
        arrowDrawable.setColorFilter(!hideArrow ? arrowColor : Color.WHITE, PorterDuff.Mode.SRC_IN);
        if (left_drawable !=0){
            if (!hideArrow){
                setCompoundDrawablesRelativeWithIntrinsicBounds(Utils.getDrawable(context, left_drawable).mutate(), null, arrowDrawable, null);
            }else {
                setCompoundDrawablesRelativeWithIntrinsicBounds(Utils.getDrawable(context, left_drawable).mutate(), null, null, null);
            }
        }else {
            if (!hideArrow){
  ...
  /*  if (!hideArrow) {
      ...
      setCompoundDrawablesWithIntrinsicBounds(drawables[0], drawables[1], drawables[2], drawables[3]);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                setTextColor(textColor == defaultColor?defaultColor:Color.WHITE);
    ...
    public void setSelectedIndex(int position) {
        if (adapter != null) {
            if (position >= 0 && position <= adapter.getCount()) {
                ...
                if (onItemSelectedListener != null) {
                    //noinspection unchecked
                    onItemSelectedListener.onItemSelected(MaterialSpinner.this, position, adapter.getItemId(position), adapter.get(position));
                }
            } /*else {
    ...
    public void setHideArrow(boolean b) {
      if (left_drawable!=0){
          if (b){
              setCompoundDrawablesRelativeWithIntrinsicBounds(Utils.getDrawable(getContext(), left_drawable).mutate(), null, null, null);
          }else {
              setCompoundDrawablesRelativeWithIntrinsicBounds(Utils.getDrawable(getContext(), left_drawable).mutate(), null, arrowDrawable, null);
          }
      }else {
          if (b){
              setCompoundDrawablesRelativeWithIntrinsicBounds(null, null, null, null);
