...
public class EditIteniraryActivity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener, OnCallBackListener, View.OnClickListener {
    ...
    private ItineriDetailModel model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = (ItineriDetailModel) bundle.getSerializable("data");
        encryptedId = bundle.getString("id");
        communication = new Communication(EditIteniraryActivity.this, this);
        initUI();
        ...
        grp_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideKeyboard(EditIteniraryActivity.this);
            }
        });
...
/*
        ...
        if (model != null) {
            ...
            edt_email.setText(model.getClient_email());
            edt_mobile.setText(model.getClient_phone());
            edt_user_name.setText(model.getClientName());
        }
        ...
        switch (view.getId()) {
            case R.id.tv_arrival_date: {
              ...
              /*  Calendar calendar = Calendar.getInstance();
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EditIteniraryActivity.this,
            ...
            case R.id.tv_dep_date: {
                ...
                if (arrival_date.getText().toString().isEmpty()) {
                    Toast.makeText(EditIteniraryActivity.this, "Select Arrival Date first", Toast.LENGTH_SHORT).show();
                    return;
                }
               /* Calendar calendar = Calendar.getInstance();
                int year = calendar.get(Calendar.YEAR);
            ...
            case R.id.btn_next: {
                if (Validator.isEmpty(edt_user_name)) {
                    ...
                    Toast.makeText(EditIteniraryActivity.this, "Select Group Type", Toast.LENGTH_SHORT).show();
                } else if (sp_pax.getSelectedIndex() == 0) {
                    Toast.makeText(EditIteniraryActivity.this, "Select Group Size", Toast.LENGTH_SHORT).show();
                } else {
                    addItinerary();
                }
            }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        if (item.getItemId() == R.id.opt_recommandation) {
            GoTo.start(EditIteniraryActivity.this, AdminRecommandationActivity.class);
        } else if (item.getItemId() == R.id.opt_gift) {
            GoTo.start(EditIteniraryActivity.this, AdminPromotionLIst.class);
        } else if (item.getItemId() == R.id.opt_notification) {
            GoTo.start(EditIteniraryActivity.this, AdminNotificationActivity.class);
        }
        return false;
    }
    ...
    public void OnCallBackSuccess(String tag, JSONObject jsonObject) {
        if (tag.equalsIgnoreCase("notification/counts")) {
            ...
            GoTo.startWithExtra(EditIteniraryActivity.this, AdminItineraryDayListActivity.class, bundle);
        } else if (tag.equals("itinerary/update")) {

            Toast.makeText(EditIteniraryActivity.this, jsonObject.optString("msg"), Toast.LENGTH_SHORT).show();
