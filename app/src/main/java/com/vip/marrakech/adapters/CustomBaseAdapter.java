...
public abstract class CustomBaseAdapter<T> extends BaseAdapter {
    ...
    public CustomBaseAdapter(Context aContext, List<T> aList) {
        mContext = aContext;
        list = aList;
    }

    public CustomBaseAdapter(Context aContext, List<T> aList, onSpinnerSelectListener<T> listener) {
        mContext = aContext;
        list = aList;
    ...
    public String getItem(int i) {
        return setSpinnerText(list.get(i));
    }
