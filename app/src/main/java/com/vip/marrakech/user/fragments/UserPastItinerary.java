...
public class UserPastItinerary extends Fragment implements OnCallBackListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tv_no_data.setText(getResources().getString(R.string.currently_you_do_not_have_any_past_bookings));
    ...
    private void getList() {
        ...
        if (NetworkUtil.isOnline(getActivity()) ) {
            ...
            try {
                data = new JSONObject(SessionManager.getPastItinerary());
                list.clear();
    ...
    public void OnCallBackSuccess(String tag, JSONObject jsonObject) {
        if (tag.equals("get/user/itinerary")) {
            try {
                ...
                if (currentPage == 1) {
                    SessionManager.setPastItinerary(data.toString());
                }
